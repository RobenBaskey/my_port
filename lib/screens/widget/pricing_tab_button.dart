...
class PricingTabButton extends StatelessWidget {
  PricingTabButton({super.key, required this.tabName, required this.index});
  String tabName;
  int index;
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: InkWell(
        onTap: () {
          _mainController.pricingType.value = index;
        },
        child: SizedBox(
            height: double.infinity,
            width: double.infinity,
            child: Obx(() {
              if (_mainController.pricingType == index) {
                return Neumorphic(
